  ...
  return (
    <html lang='en'>
      <body className='min-h-screen flex flex-col'>
        {/* LBBD Council Header — matches eforms.lbbd.gov.uk */}
        <header className='bg-[#00473E] text-white'>
          <div className='max-w-5xl mx-auto px-4 sm:px-6'>
            <div className='flex items-center justify-between h-16'>
              ...
              >
                ...
                <div className='sm:hidden text-sm font-bold'>LBBD</div>
              </a>
              <nav className='flex items-center gap-4 text-sm'>
                ...
                <a
                  href='/admin'
                  className='text-white/70 hover:text-white hover:underline underline-offset-4'
                >
                  Admin
                </a>
              </nav>
          ...
          {/* AI PoC banner */}
          <div className='bg-[#4C9F38] text-white text-center py-1.5 text-xs font-medium tracking-wide'>
        ...
        {/* LBBD Council Footer — matches eforms.lbbd.gov.uk */}
        <footer className='bg-[#00473E] text-white mt-auto'>
          {/* Social media bar */}
